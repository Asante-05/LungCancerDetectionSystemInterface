  ...
  return (
    <Layout>
      {!viewParticular && !resultReady && (
        <>
          <div className="flex justify-between items-center p-3 rounded-full bg-white m-5 ">
            <div className="w-[80%] flex ">
              <section className="w-[70%]">
                <input
                  ...
                  className=" rounded-lg w-[100%]  bg-white-700 mt-2  focus:border-blue-500 focus:bg-gray-200 focus:outline-none"
                  type="text"
                  placeholder="search for patients here with Id of the patient"
                />
              </section>
              <section className="w-[30%]">
                <button className=" mr-5 md:mr-8 cursor-pointer  bg-orange-100 text-gray-700 flex gap-2   p-6 py-3  rounded text-center   items-center transition-colors   hover:bg-orange-100 hover:text-orange-500">
                  Search
                </button>
              </section>
            </div>
            ...
            <div className="w-[20%]">
              <Popover className="relative">
                ...
                >
                  <Popover.Panel className="absolute flex align-center  justify-between h-60  -right-16 sm:right-4 z-50 mt-2 bg-white shadow-lg rounded max-w-xs sm:max-w-sm w-screen">
                    <div className="relative p-3">
                      ...
                      <div className="mt-4 grid gap-4 grid-cols-1 overflow-hidden">
                        ...
                        <div className="flex justify-between ">
                          <button
                            className={`p-6 py-3 mx-5 rounded text-center cursor-pointer mb-3 flex items-center transition-colors text-gray-400 hover:bg-orange-100 hover:text-orange-500`}
                          >
                            Cancel
                          </button>
                          <button
          ...
          <div className=" mb-16">
            <div className="flex items-center justify-center rounded-[24px]  bg-white text-2xl h-20 shadow-sm lg:gap-[10%] md:gap-[5%] sm:gap-[2%]">
          ...
          {/*  <div className="grid py-5 overflow-y-scroll scroll-smooth rounded-xl items-center justify-center col-1 bg-white h-96 shadow-sm ">
            {data.map((tuple, key) => (
              <div key={key} className="flex lg:gap-[35%] md:gap-[5%] sm:gap-[2%] ">
                <div>
