            ...
            {/* <Popover.Panel className="absolute flex align-center  justify-between h-60  -right-16 sm:right-4 z-50 mt-2 bg-white shadow-lg rounded max-w-xs sm:max-w-sm w-screen">
              ...
              <div className="relative p-3">
                <div className="flex justify-between items-center w-full">
                  <p className="text-gray-700 font-medium">Perform a new scan</p>
                ...
                <div className="mt-4 grid gap-4 grid-cols-1 overflow-hidden">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex justify-between ">
                      <button className={`p-6 py-3 mx-5 rounded text-center cursor-pointer mb-3 flex items-center transition-colors text-gray-400 hover:bg-orange-100 hover:text-orange-500`}>
                        Cancel
                      </button>
                      <button className={`p-6 py-3 mx-5 rounded text-center cursor-pointer mb-3 flex items-center transition-colors text-gray-400 hover:bg-orange-100 hover:text-orange-500`} onClick={() => handleFileUpload()}>
                        Start
                      </button>
                    </div>
